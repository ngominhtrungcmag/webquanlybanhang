            ...
            <tbody>
                <tr>
                    ...
                    <td><a class="btn btn-danger btn-submit btn-sm"
                            href="index.php?action=view_users&delete_user=<?php echo $row['id']; ?>">Delete</a></td>
                </tr>
            </tbody>
...
if (isset($_GET['delete_user'])) {
  $delete_user = mysqli_query($con, "delete from KhachHang where MSKH='$_GET[delete_user]' ");
